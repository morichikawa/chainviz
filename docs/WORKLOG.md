...
| #211ほか | Issue #211/#212/#213/#215/#218/#219 UX上の6課題を実環境で評価し、4つの実装単位(A:#215 役割可視化、B:#213+#219 操作説明、C:#211+#218 一覧と導線、D:#212 txライフサイクル)へ切り分けたUX設計 | [2026-07-10](worklog/issue-211.md) |
