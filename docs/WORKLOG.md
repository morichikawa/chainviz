...
| #229 | Issue #229 PROTO-CMD-01が長時間稼働スタックで失敗する件の原因調査。EL間P2Pバックフィルの回帰ではなく、追いつき所要時間(稼働時間÷20)がテストの固定上限540秒を超えることが根本原因と特定。コード修正なし | [2026-07-10](worklog/issue-229.md) |
