...
| #209 | Issue #209 デプロイ/呼び出しフォームのコンストラクタ引数・関数引数にABI型（uint/address）ベースのクライアント側バリデーションを追加(frontend分)。collector側のエラーメッセージサニタイズは別作業として残る | [2026-07-10](worklog/issue-209.md) |
