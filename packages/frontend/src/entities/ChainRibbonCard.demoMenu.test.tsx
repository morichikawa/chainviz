...
// `docs/worklog/issue-414.md` UX設計 §4)の開閉挙動そのものの確認。個々の
// 入口ボタン(ハッシュのしくみ・51%攻撃)のクリック挙動は
// ChainRibbonCard.hashDemoEntry.test.tsx / .attack51DemoEntry.test.tsx が
...
describe("ChainRibbonCard: learning sandbox menu (Issue #414)", () => {
  ...
  it("opens when the summary is clicked and lists both sandbox entries", () => {
    renderCard();
